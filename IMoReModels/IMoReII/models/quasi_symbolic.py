...
class DifferentiableReasoning(nn.Module):
    ...
    def forward(self, batch_features, progs):
        ...
        print("in quasi-> programs: ", len(programs), programs)
        print("in quasi-> buffers: ", len(buffers), buffers)
        print("in quasi-> result: ", len(result), result)
        # programs, buffers, answers
        # print(1/0)
